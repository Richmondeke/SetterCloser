...
export default function SettingsPage() {
  ...
  return (
    <div className="w-full max-w-3xl">
      ...
      <h1 className="text-[#ffffff] text-[38px] tracking-[-1.14px] font-normal mt-1">Settings</h1>
      ...
      <div className="card-dark mt-8">
        ...
        {/* Change Password */}
        <button className="text-[#55beff] text-[14px] hover:underline cursor-pointer">Change Password →</button>
      </div>
      ...
      <div className="bg-[#212121] rounded-[12px] p-8 border border-[#dd0000] mt-4">
        ...
        <button className="text-[#dd0000] border border-[#dd0000] rounded-full h-[44px] px-6 font-medium cursor-pointer transition hover:bg-[#dd0000] hover:text-[#ffffff]">
          Delete Account
        </button>
      </div>
    </div>
